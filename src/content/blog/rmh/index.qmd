...
This evening, we look at R and healthcare from three angles: how [**SWICA**](https://www.swica.ch/en/private), a major health insurer, uses data to shift towards value-based care, how the [**Swiss Health Observatory**](https://www.obsan.admin.ch/en) uses R to plan and allocate resources across cantons, and how [**Swisstransplant**](https://www.swisstransplant.org/de/) uses statistical modelling to understand and predict organ transplants.
...
> Register on Meetup [**here**](https://www.meetup.com/zurich-r-user-group/events/315351784/?eventOrigin=group_events_list)